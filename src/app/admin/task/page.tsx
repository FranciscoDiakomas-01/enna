...
export default function Tasks() {
  ...
  return (
    <main>
      ...
      <button
        className=" fixed flex gap-[5px] items-center justify-center text-white bg-orange-400  text-[13px]  rounded-full w-[40px] h-[40px] bottom-10 right-5 z-[9999] cursor-pointer"
        onClick={() => {
          setAdd((prev) => !prev);
        }}
      >
        ...
        <>
          {tasks.length > 0 ? (
            <>
              ...
              <footer className="flex justify-between items-center border-t pt-2 lg:mb-0 mb-[100px]">
                <p>1 de 10</p>
